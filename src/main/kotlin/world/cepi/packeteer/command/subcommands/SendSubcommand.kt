...
object SendSubcommand : Kommand(k@ {
    ...
    val failedPackets = ServerPackets.serverPackets.filter { clazz ->
        ...
        val emptyConstructor = clazz.constructors.firstOrNull { it.parameterCount == 0 } as? Constructor<out ServerPacket>
            ?: return@filter true
        ...
        syntax(players, packetName.literal(), *arguments.keys.toTypedArray()) {
